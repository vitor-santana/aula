    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <form class="form-horizontal" action="/index.php/controller/doPostContato" method="post" accept-charset="utf-8">
                    ...
                    <div class="form-group">    
                        <label for="tituloMensagem" class="col-sm-3 control-label">Título:</label> 
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="tituloMensagem" placeholder="Digite o título da mensagem"/>
                        </div>                                
                    </div>
                    <div class="form-group">    
                        <label for="conteudoMensagem" class="col-sm-3 control-label">Mensagem:</label> 
                        <div class="col-sm-6">
                            <textarea  class="form-control" rows="3" name="conteudoMensagem" placeholder="Digite sua mensagem"></textarea> 
                        </div>                                
                    </div>
                    <div class="form-group">    
